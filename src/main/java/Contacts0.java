...
public class Contacts0 {
    ...
    public static void main(String[] args) {
        ...
        int count = 0;
        while (true) {
            System.out.print(WORD_SEPERATOR + "Enter command: ");
            ...
            case "add":
                ...
                if (decodeResult == null) {
                    feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + WORD_SEPERATOR)
                            + "%2$s", "add", String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + WORD_SEPERATOR)
                            + String.format("\tParameters: %1$s", "NAME "
                            + "p/" + "PHONE_NUMBER "
                            + "e/" + "EMAIL") + (System.lineSeparator() + WORD_SEPERATOR)
                            + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + WORD_SEPERATOR));
                    break;
                }
            ...
            case "list":
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    messageAccumulator.append('\t').append(String.format("%1$d. ", displayIndex))
                            ...
                            .append(System.lineSeparator()).append(WORD_SEPERATOR);
                }
                String listAsString = messageAccumulator.toString();
                for (String m1 : new String[]{listAsString}) {
                    System.out.println(WORD_SEPERATOR + m1);
                }
            ...
            case "clear":
                ...
                break;
            case "help":
                feedback = (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")+ (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + WORD_SEPERATOR) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")+ (System.lineSeparator() + WORD_SEPERATOR)
            ...
            default:
                feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + WORD_SEPERATOR)
                        + "%2$s", commandType, (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "find", "Finds all persons whose names contain any of the specified "
                        + "keywords (case-sensitive) and displays them as a list with index numbers.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tParameters: %1$s", "KEYWORD [MORE_KEYWORDS]") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "find" + " alice bob charlie") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + WORD_SEPERATOR)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + WORD_SEPERATOR)) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + WORD_SEPERATOR)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")
                        + String.format("\tExample: %1$s", "help")));
                break;
            }
            for (String m : new String[]{feedback, "==================================================="}) {
                System.out.println(WORD_SEPERATOR + m);
            }
        }
    }
