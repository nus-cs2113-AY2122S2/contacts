...
public class Contacts0 {
    ...
    public static void main(String[] args) {
        ...
        int count = 0;
        while (true) {
            System.out.print(STRING + "Enter command: ");
            ...
            case "add":
                ...
                if (decodeResult == null) {
                    feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + STRING)
                            + "%2$s", "add", String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + STRING)
                            + String.format("\tParameters: %1$s", "NAME "
                            + "p/" + "PHONE_NUMBER "
                            + "e/" + "EMAIL") + (System.lineSeparator() + STRING)
                            + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + STRING));
                    break;
                }
            ...
            case "clear":
                ...
                break;
            case "help":
                feedback = (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + STRING)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")+ (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + STRING) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")+ (System.lineSeparator() + STRING)
            ...
            default:
                feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + STRING)
                        + "%2$s", commandType, (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + STRING)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "find", "Finds all persons whose names contain any of the specified "
                        + "keywords (case-sensitive) and displays them as a list with index numbers.") + (System.lineSeparator() + STRING)
                        + String.format("\tParameters: %1$s", "KEYWORD [MORE_KEYWORDS]") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "find" + " alice bob charlie") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + STRING)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + STRING)) + (System.lineSeparator() + STRING)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + STRING)
